...
def menu_screen(tick, image_index, myScreen, customization_screen, leaderboard, last_score=-1):
    ...
    while running:
        ...
        #Playing game part
            ...
            tick, image_index = menu_screen(
                tick, image_index, myScreen, customization_screen, leaderboard, last_score)
